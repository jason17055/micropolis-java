...
public class CityEval
{
	...
	void calculateAssValue()
	{
        ...
        z += (engine.uniaCount + engine.unibCount) * 1500;
        z += engine.museumCount * 1000;
        z += engine.openairCount * 1000;
        z += engine.cityhallCount * 3000;
	...
	void doProblems()
	{
        ...
        problemTable.put(CityProblem.NOEDUCATION, 255 - engine.educationAverage);
